...
import com.rains.design.action.OccupyDlgApplyMouseListener;
import com.rains.design.action.OccupyDlgFontMouseListener;
import com.rains.design.action.OccupyDlgTypeMouseListener;
import com.rains.design.component.OccupyFont;
import com.rains.design.constant.OutType;
import com.rains.design.vo.*;
...
public class OccupyDialog extends JDialog {
     ...
     * @param vo
     */
    private void initDisplayValue(Layer vo) {
        if (vo == null) {
            return;
        }
        this.nameTxt.setText(vo.getText());
        this.widthTxt.setText(String.valueOf(vo.getWidth()));
        this.heightTxt.setText(String.valueOf(vo.getHeight()));
        FontColorVO fontColorVO = new FontColorVO();
        FontVO fontVO = new FontVO();
        fontVO.setName(vo.getFontFamily());
        fontVO.setSize(vo.getFontSize());
        fontVO.setStyle( Font.PLAIN);
        fontColorVO.setFont(fontVO);
        ...
        fontColorVO.setColor(colorVO);

        this.fcBtn.setData(fontColorVO);
...
//        }
     ...
     * @throws Exception
     */
    public Layer getData() throws Exception {
        inVO.setText(nameTxt.getText());
        inVO.setWidth(Integer.valueOf(widthTxt.getText()));
        inVO.setHeight(Integer.valueOf(heightTxt.getText()));
        FontVO font =fcBtn.getData().getFont();
        inVO.setFontFamily(font.getName());
        inVO.setFontSize(font.getSize());
