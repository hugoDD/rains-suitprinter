...
public class PrinterUtils {
    ...
    public static BufferedImage printToImage(List<Pager> pagers, PixelPaper pixelPaper) throws IOException {
        ...
        for (Pager pager : pagers) {
            ...
            if(Objects.isNull(pager.getBaseImage())){
                 preview = new BufferedImage(pixelPaper.getWidth(), pixelPaper.getHeight(), BufferedImage.TYPE_INT_ARGB);
            }else{
                 preview = pager.createImage();
